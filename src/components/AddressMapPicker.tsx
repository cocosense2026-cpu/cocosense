...
interface AddressMapPickerProps {
  ...
  focusLat: number;
  focusLng: number;
  /** Zoom level to snap to on that recenter. Defaults to 14 (municipality-level). */
  focusZoom?: number;
...
const RecenterOnFocus: React.FC<{ focusToken: string; lat: number; lng: number; zoom: number }> = ({
  focusToken,
  lat,
  lng,
  zoom,
  ...
  return (
    <div className="rounded border border-[#262626] overflow-hidden">
      ...
      >
        ...
        />
        <RecenterOnFocus focusToken={focusToken} lat={focusLat} lng={focusLng} zoom={focusZoom} />

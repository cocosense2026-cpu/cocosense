...
export const INITIAL_NODES: MasterNode[] = [
  {
    ...
    sensors: [
      { id: 'PZ-001-A1', treeId: 'TR-1045', status: 'OPTIMAL', frequencyHz: 42, voltageMv: 3290 },
      { id: 'PZ-001-A2', treeId: 'TR-1046', status: 'OPTIMAL', frequencyHz: 38, voltageMv: 3280 },
      { id: 'PZ-001-A3', treeId: 'TR-1047', status: 'OPTIMAL', frequencyHz: 45, voltageMv: 3300 },
      { id: 'PZ-001-A4', treeId: 'TR-1048', status: 'WORKING', frequencyHz: 345, voltageMv: 3250 },
      { id: 'PZ-001-A5', treeId: 'TR-1049', status: 'WORKING', frequencyHz: 290, voltageMv: 3240 },
      { id: 'PZ-001-A6', treeId: 'TR-1050', status: 'OPTIMAL', frequencyHz: 48, voltageMv: 3295 },
    ]
  },
  {
    id: 'NODE-002',
    ...
    sensors: [
      { id: 'PZ-002-B1', treeId: 'TR-2101', status: 'OPTIMAL', frequencyHz: 52, voltageMv: 3285 },
      { id: 'PZ-002-B2', treeId: 'TR-2102', status: 'OPTIMAL', frequencyHz: 65, voltageMv: 3270 },
      { id: 'PZ-002-B3', treeId: 'TR-2103', status: 'OPTIMAL', frequencyHz: 41, voltageMv: 3290 },
      { id: 'PZ-002-B4', treeId: 'TR-2104', status: 'OPTIMAL', frequencyHz: 39, voltageMv: 3300 },
      { id: 'PZ-002-B5', treeId: 'TR-2105', status: 'OPTIMAL', frequencyHz: 44, voltageMv: 3290 },
      { id: 'PZ-002-B6', treeId: 'TR-2106', status: 'OPTIMAL', frequencyHz: 50, voltageMv: 3280 },
    ]
  },
  {
    id: 'NODE-003',
    ...
    sensors: [
      { id: 'PZ-003-C1', treeId: 'TR-3301', status: 'WORKING', frequencyHz: 480, voltageMv: 2890 },
      { id: 'PZ-003-C2', treeId: 'TR-3302', status: 'WORKING', frequencyHz: 420, voltageMv: 2910 },
      { id: 'PZ-003-C3', treeId: 'TR-3303', status: 'DAMAGED', frequencyHz: 0, voltageMv: 1100 },
      { id: 'PZ-003-C4', treeId: 'TR-3304', status: 'DAMAGED', frequencyHz: 0, voltageMv: 1050 },
      { id: 'PZ-003-C5', treeId: 'TR-3305', status: 'WORKING', frequencyHz: 55, voltageMv: 2920 },
      { id: 'PZ-003-C6', treeId: 'TR-3306', status: 'WORKING', frequencyHz: 58, voltageMv: 2930 },
    ]
  },
  {
    id: 'NODE-004',
    ...
    sensors: [
      { id: 'PZ-004-D1', treeId: 'TR-4401', status: 'WORKING', frequencyHz: 280, voltageMv: 3310 },
      { id: 'PZ-004-D2', treeId: 'TR-4402', status: 'OPTIMAL', frequencyHz: 45, voltageMv: 3320 },
      { id: 'PZ-004-D3', treeId: 'TR-4403', status: 'OPTIMAL', frequencyHz: 40, voltageMv: 3315 },
      { id: 'PZ-004-D4', treeId: 'TR-4404', status: 'OPTIMAL', frequencyHz: 48, voltageMv: 3310 },
      { id: 'PZ-004-D5', treeId: 'TR-4405', status: 'OPTIMAL', frequencyHz: 43, voltageMv: 3325 },
      { id: 'PZ-004-D6', treeId: 'TR-4406', status: 'OPTIMAL', frequencyHz: 46, voltageMv: 3318 },
    ]
  },
  {
    id: 'NODE-005',
    ...
    sensors: [
      { id: 'PZ-005-E1', treeId: 'TR-5501', status: 'OPTIMAL', frequencyHz: 38, voltageMv: 3260 },
      { id: 'PZ-005-E2', treeId: 'TR-5502', status: 'OPTIMAL', frequencyHz: 42, voltageMv: 3265 },
      { id: 'PZ-005-E3', treeId: 'TR-5503', status: 'OPTIMAL', frequencyHz: 39, voltageMv: 3270 },
      { id: 'PZ-005-E4', treeId: 'TR-5504', status: 'OPTIMAL', frequencyHz: 44, voltageMv: 3262 },
      { id: 'PZ-005-E5', treeId: 'TR-5505', status: 'OPTIMAL', frequencyHz: 41, voltageMv: 3268 },
      { id: 'PZ-005-E6', treeId: 'TR-5506', status: 'OPTIMAL', frequencyHz: 45, voltageMv: 3264 },
    ]
  }
];
...
class PsgcAddressPicker extends Component
{
  ...
  },
  {
    ...
    category: 'Hardware & Nodes',
    description: 'Hardware control hub monitoring 6 piezoelectric sensors per node with battery level, signal RSSI, live Reboot, and Take Offline action endpoints.',
    props: [

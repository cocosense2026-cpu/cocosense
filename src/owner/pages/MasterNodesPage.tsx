...
import { AddMasterNodeModal } from '../components/AddMasterNodeModal';
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <PageHero
        ...
        description="Live health of the master control hubs and piezoelectric transducers monitoring your estate. Health data is view-only; you can add new hardware here by scanning its QR sticker."
        actions={
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2 rounded bg-[#D4AF37] hover:bg-[#E5C158] text-black font-bold text-[11px] uppercase tracking-wider transition-colors"
            >
      ...
      <PageFooterNote
        icon={Radio}
        text="Health data and controls here are view-only -- reboot and power actions remain restricted to the Admin console. Adding a master node by QR is the one action owners can take from this screen."
      />
      ...
      {addNodeOpen && (
        <AddMasterNodeModal
          ...
          onLinked={(node) => {
            refresh();
            setToast(`${node.id} added to your master node mesh.`);

...
import { ShieldCheck, Radio, Users, AlertCircle } from 'lucide-react';
          ...
          <div className="lg:w-[46%] flex flex-col justify-between gap-8 p-6 sm:p-10 lg:border-r border-[#16A34A]/15">
            <div className="space-y-6">
              <h2 className="text-2xl sm:text-3xl font-bold text-white leading-tight tracking-tight serif">
                Command the whole plantation network.
              </h2>
              <p className="text-sm text-[#A0A0A0] leading-relaxed max-w-sm">
                Monitor every master node, farm owner, and pest alert across the ASCOT &amp; PCA LoRa mesh from one
                console.
              </p>

              <div className="space-y-3 pt-2">
                {[
                  { icon: Radio, text: 'Network-wide LoRa mesh telemetry' },
                  { icon: Users, text: 'Provision & manage farm owner accounts' },
                  { icon: ShieldCheck, text: 'Restricted to authorized administrators' },
                ].map(({ icon: Icon, text }) => (
...
export const adminAuthButtonClass =
